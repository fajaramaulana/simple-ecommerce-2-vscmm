...
@section('content')
    ...
    @if (request()->search)
        <div class="container " style="margin-top: 4rem">
            <h3 style="font-family: 'Playfair Display', serif;">Pencarian Product {{ request()->search }}</h3>
                    ...
                    <div class="col-3 h-100" style="height: 100%!important">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div>
                                    <b
                                        style="font-family: 'Playfair Display', serif; font-size: 20px;">{{ $product->product_name }}</b>
                                </div>
                                <div>
            ...
            <div class="mt-5 text-center">
                <a href="{{ route('welcomepage.index') }}" class="px-3 py-2"
                    style="font-size: 20px; padding-top: 3rem; padding-bottom: 3rem; border: 1px solid #41A0E4; color: #41A0E4; text-decoration: none; font-family: 'Poppins', sans-serif">Lihat
                    Lebih Banyak</a>
            </div>
        </div>
    @else
