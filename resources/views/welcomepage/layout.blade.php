...
<body style="width: 100vw; height: 100vh; overflow-x:hidden;">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search" action="{{ route('welcomepage.index') }}">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari Parfum Kesukaanmu"
                            aria-label="Cari Parfum Kesukaanmu" aria-describedby="button-addon2" name="search"
                            size="80" @if (request()->search) value="{{ request()->search }}" @endif>
                ...
                <div class="ms-auto me-4">
                    @if (Auth::check() && Auth::user()->role == 'user')
                        ...
                        <a href="#" class="px-3 py-2"
                            style="font-size: 16px; padding-top: 3rem; padding-bottom: 3rem; border: 1px solid #41A0E4; color: #41A0E4; text-decoration: none;"
                            onclick="event.preventDefault();  console.log('Clicked!'); document.getElementById('logout-form').submit();">
                            LOGOUT
                        </a>
                    @elseif (Auth::check() && Auth::user()->role == 'admin')
                        <a href="{{route('admin.dashboard')}}" class="px-3 py-2"
                            style="font-size: 16px; padding-top: 3rem; padding-bottom: 3rem; border: 1px solid #41A0E4; background-color: #41A0E4; color: white; text-decoration: none;">DASHBOARD</a>
                        <form id="logout-form" action="{{ route('logout') }}" method="post" style="display: none;">
                            @csrf
                        </form>
                        <a href="#" class="px-3 py-2"
    ...
    {{-- footer --}}
    <div class="row"
        style="padding-left: 5vw; padding-right: 5vw; padding-top: 5vwh; padding-bottom: 5vh;margin-top: 6rem;">
        <div class="col-4 text-center">
            <div>
                <img src="{{ asset('image/logo.png') }}" alt="">
            </div>
            <div class="mt-3">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Ut commodo in vestibulum, sed dapibus <br>
                tristique nullam.
            </div>
            <div class="mt-3">
                <a href="#">
